                ...
                <img class=\"card-img-top\" src=\"data:image/jpeg;base64,{$thumbnail}\" alt=\"Thumbnail\" >
                    ...
                    if (isset($_SESSION['usr_id'])) {
                      ...
                      if (0<mysqli_num_rows($res_is_subscribed)) {
                       echo "<a href=\"profile.php#{$item['newspaper_id']}\" class=\"btn btn-outline-primary\">Subscribed</a>";
                      }else{
                        echo "<a href=\"choose-plan.php?id-subscribe={$item['newspaper_id']}\" class=\"btn btn-primary\">Subscrib</a>";
                      }                      
                    }else{
                      echo "<a href=\"sign.php\" class=\"btn btn-primary\">Subscrib</a>";
                    }
